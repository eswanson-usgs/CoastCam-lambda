...
Lambda function is triggered by image uploaded to the CACO-02 S3 coastcam bucket at with the prefix ('directory') cameras/caco-02/products/. Lambda function will not trigger 
...
def get_new_keys(old_key):
    ...
    if len(filename_elements) != 10:
        ...
        #reformat filename
        new_filename = filename.replace(station, 'caco-02')
        
        new_key = "cameras/caco-02/" + cam_num + "/" + year + "/" + new_format_day + '/' + new_filename
        new_product_key = "cameras/caco-02/products/" + new_filename
