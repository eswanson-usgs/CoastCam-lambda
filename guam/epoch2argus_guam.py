"""
Eric Swanson
Purpose: Convert the filename for an images at Guam from the epoch only format to the argus format filename.
...
The old filepath is in the format s3:/cmgp-coastcam/cameras/guam/products/[long filename].
The new filepath is in the format s3:/cmgp-coastcam/cameras/guam]/[camera]/[year]/[day]/raw/[longfilename].
