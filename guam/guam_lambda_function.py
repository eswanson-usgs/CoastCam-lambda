...
Lambda function is triggered by image uploaded to the Guam S3 coastcam bucket at with the prefix ('directory') cameras/guam/products/. Lambda function will not trigger 
...
def get_new_keys(old_key):
    ...
    if len(filename_elements) != 10:
        ...
        new_key = "cameras/guam/" + cam_num + "/" + year + "/" + new_format_day + '/' + new_filename
        new_product_key = "cameras/guam/products/" + new_filename
