#Email alert LAmbda function for Guam. Triggers once a day at 10 AM local and checks if any new imagery made it to the /latest folder. Does so by checking the csv file
...
def lambda_handler(event, context):
    ...
    csv_key = "cameras/guam/guam_most_recent_time.csv"
    
    #need to download csv to temp folder
    download_path = '/tmp/guam_most_recent_time.csv'
    ...
    latest_prefix = "cameras/guam/latest"
