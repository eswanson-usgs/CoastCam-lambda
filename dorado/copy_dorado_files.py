"""
Eric Swanson
Purpose: Copy images for Dorado in the CoastCam S3 bucket from the /products folder to the appropriately formated camera/date folders.
"""
...
def copy_dorado_image(source_filepath):
    """
...
with concurrent.futures.ThreadPoolExecutor() as executor:
    results = executor.map(copy_dorado_image, image_list)
