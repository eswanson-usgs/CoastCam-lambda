#Email alert LAmbda function for Unalakleet, AK. Triggers once a day at 10 AM local and checks if any new imagery made it to the /latest folder. Does so by checking the csv file
...
def lambda_handler(event, context):
    ...
    csv_key = "cameras/unalakleet/unalakleet_most_recent_time.csv"
    
    #need to download csv to temp folder
    download_path = '/tmp/unalakleet_most_recent_time.csv'
    ...
    latest_prefix = "cameras/unalakleet/latest"
