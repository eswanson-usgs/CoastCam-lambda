"""
Eric Swanson
The purpose of this script is to convert the S3 filepath for all images in a folder in the unalakleet
...
##            if int(image_unix_time) >= 1664548205:
...
source_folder = "s3://cmgp-coastcam/cameras/unalakleet/products"  

#station unalakleet for testing
file_system = fsspec.filesystem('s3', profile='coastcam')
...
csv_path = "C:/Users/eswanson/OneDrive - DOI/Documents/GitHub/CoastCam-lambda/unalakleet/csv/"
csv_list = []
