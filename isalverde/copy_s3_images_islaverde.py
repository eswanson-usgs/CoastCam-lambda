"""
Eric Swanson
The purpose of this script is to convert the S3 filepath for all images in a folder in the Isla Verde
...
csv_path = "C:/Users/eswanson/OneDrive - DOI/Documents/GitHub/CoastCam-lambda/islaverde/csv/"
csv_list = []
