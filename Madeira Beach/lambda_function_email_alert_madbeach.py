#Lambda function for sending email alerts for missing Madeira Beach files
import boto3
import datetime
...
def lambda_handler(event, context):
    ...
    prefix = 'cameras/madeira_beach/products'
    ...
    if not newFilesExist:
        ...
        alert = 'ALERT: no files recently uploaded for Madeira Beach between {} UTC and {} UTC!\nemail timestamp: '.format(time_check, time_check_plus1) + str(timestamp)
