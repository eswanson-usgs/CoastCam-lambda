"""
Eric Swanson
The purpose of this script is to copy images from the Madeira Beach 2017_data_release folder to the CIRN
formatted folder i.e. madeira_beach/[cam #]/[year]/[day]/
"""
...
source_folder = "s3://cmgp-coastcam/cameras/madeira_beach/2017_data_release"  

#station madbeach for testing
file_system = fsspec.filesystem('s3', profile='coastcam')
...
csv_path = "C:/Users/eswanson/OneDrive - DOI/Documents/GitHub/CoastCam-lambda/madbeach/csv/"
csv_list = []
