"""
Eric Swanson
Purpose: Convert the filename for an images at caco-02 from the epoch only format to the argus format filename.
...
The old filepath is in the format s3:/cmgp-coastcam/cameras/caco-02/products/[long filename].
The new filepath is in the format s3:/cmgp-coastcam/cameras/caco-02]/[camera]/[year]/[day]/raw/[longfilename].
...
source_folder = "s3://cmgp-coastcam/cameras/caco-02"
...
source_folder = "s3://cmgp-coastcam/cameras/caco-02/products"                        
