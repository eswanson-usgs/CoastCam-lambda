'''
Send an email alert once daily for CACO-02 coastcam. Send a tally of total images collected between both cameas for that day, as well as the first and last files for each camera. Append the tally
...
def send_email_alert(Data):
    ...
    response = ses_client.send_email(
        ...
        Message={
            ...
            "Subject": {
                "Charset": CHARSET,
                "Data": "CACO-02 Daily Email Alert",
            },
        },
...
def lambda_handler(event, context):
    ...
    c1_prefix = 'cameras/caco-02/c1/' + year + '/' + new_format_day
    c2_prefix = 'cameras/caco-02/c2/' + year + '/' + new_format_day
    
    ########PLACEHOLDER FOR TESTING
    # c1_prefix = 'cameras/caco-02/c1/' + year + '/274_Oct.01'
    # c2_prefix = 'cameras/caco-02/c2/' + year + '/274_Oct.01'
    ...
    if tally != 0:
        ...
        #format email
        email = f"Total number of images for CACO-02 on {today}: {tally}\n"
    ...
    #no files found for today    
        ...
        email = 'ALERT: no files uploaded for CACO-02 on {}!\nemail timestamp: '.format(today) + str(timestamp)
    ...
    csv_path = "cameras/caco-02/caco-02_daily_tally.csv"
    download_path = '/tmp/caco-02_daily_tally.csv'
