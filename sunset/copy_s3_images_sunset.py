"""
Eric Swanson
The purpose of this script is to convert the S3 filepath for all images in a folder in the Sunset
...
source_folder = "s3://cmgp-coastcam/cameras/sunset/products"  

#station sunset for testing
file_system = fsspec.filesystem('s3', profile='coastcam')
...
csv_path = "C:/Users/eswanson/OneDrive - DOI/Documents/GitHub/CoastCam-lambda/sunset/csv/"
csv_list = []
