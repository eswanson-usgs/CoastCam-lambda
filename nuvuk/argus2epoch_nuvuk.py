"""
Eric Swanson
Purpose: Convert the filename for an images at Nuvuk from argus format to the epoch-only format
...
def argus2epoch(args):
    ...
    if isImage == True:
        ...
        if len(filename_elements) == 10:
            ...
            #reformat filename
            new_filename = f"{image_unix_time}.{cam_num}.{image_type}.{image_file_type}"
