"""
Eric Swanson
The purpose of this script is to convert the S3 filepath for all runup .mat file for Sand Key to a new filepath in S3 under the /cx folder.
"""
