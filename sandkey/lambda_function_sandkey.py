...
Lambda function is triggered by image uploaded to the Sand Key S3 coastcam bucket at with the prefix ('directory') cameras/sandkey/products/. Lambda function will not trigger 
