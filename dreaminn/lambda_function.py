...
Lambda function is triggered by image uploaded to the Dream Inn S3 coastcam bucket at with the prefix ('directory') cameras/dreaminn/products/. Lambda function will not trigger 
...
def get_new_keys(old_key):
    ...
    if len(filename_elements) != 4:
        ...
        new_key = "cameras/dreaminn/" + cam_num + "/" + year + "/" + new_format_day + '/' + new_filename
        new_product_key = "cameras/dreaminn/products/" + new_filename
